...
# Evolution Intelligence — The GTI Layer
...
For Q7 platform brand: see BRAND_SYSTEM.md
...
Whale Alert trigger (automated via Scout Agent):
  Turnover change > 2 standard deviations
...
| Analysis    | 5–20s  | Concrete data: sectional ranking, price compression, turnover change |

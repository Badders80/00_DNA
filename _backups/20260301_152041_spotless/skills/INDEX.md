...
- `approved_sources.md` — Curated repositories and tools (don't reinvent the wheel)
- `starred_repo_registry.md` — Auto-generated starred repo review registry
- `starred_repo_registry.json` — Canonical starred repo registry (status/category/notes)
